//! Generate unique HTML element IDs from heading-like content.
//!
//! This is vendored from `mdbook`, which no longer exposes this
//! functionality publicly as of mdbook 0.5.
use regex::Regex;
...
/// each call.
pub(crate) fn unique_id_from_content(
    content: &str,
