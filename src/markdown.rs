...
use crate::flavours::{build_flavour_map, Flavour};
use crate::{
...
pub(crate) fn preprocess(
    ...
    for (event, span) in events.into_offset_iter() {
        if let Event::Start(Tag::CodeBlock(Fenced(info_string))) = event.clone() {
            ...
            // Once we've identified admonition blocks, handle them differently
            // depending on our render mode
            let new_content = match render_text_mode {
                RenderTextMode::Html => admonition.html(&flavours, &mut id_counter),
    ...
    fn indent_of_samples() {
        for (content, position, max, expected) in [
            ...
            (
                ...
                "例".len(),
                // Any arbitrary safety limit should be valid
                1,
                // Should not panic
                0,
            ),
...
<div id="admonition-caution" class="admonition admonish-caution">
<div class="admonition-title">
...
"##;
    ...
    fn leaves_tables_untouched() {
        // Regression test.
        // Previously we forgot to enable the same markdown extensions as mdbook itself.
...
<div id="yay-custom-id" class="admonition admonish-check">
<div class="admonition-title">
...
<div id="admonition-check" class="admonition admonish-check">
<div class="admonition-title">
...
<div id="admonition-check-mark" class="admonition admonish-check">
<div class="admonition-title">
